...
| **3. Validation** | `Claude Opus 4.6` | **Senior Tech Lead** | High-level reasoning, concurrency audits, and security validation. |
...
2. **Design (C4.6 Opus):** Review and harden the implementation plan.
